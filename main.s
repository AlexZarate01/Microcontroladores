...
DELAY:
    MOVLW   80			;1xTCY
    MOVWF   BANKMASK(VARIBLE01),0 ;1xTCY		
DELAY_02:
    MOVLW   256			;1xTCY
    MOVWF   BANKMASK(PCOUNTER),0 ;1xTCY		
DELAY_COUNTER:
    DECFSZ  BANKMASK(PCOUNTER),1,0	;(256-1)*1+3 TCY
    GOTO    DELAY_COUNTER		;(256-1)*2 TCY
    DECFSZ  BANKMASK(VARIBLE01),1,0	;(80-1)*1+3 TCY	
    GOTO    DELAY_COUNTER		;(80-1)*2 TCY
    RETURN				;2*TCY	
END resetVec
